...
const page2=Marked(page2Raw);

const page3Raw=`
# 更多

刚学前端编程的时候写过几个小游戏,请点击[这里](pengchongfu.com/game)
`;
var page3=Marked(page3Raw);
const arr=page3.split("<a");
...
class Page extends React.Component {
  ...
  render(){
    ...
    return (
      <div
        style={{paddingTop:100,width:"80%",margin:"0 auto","wordWrap":"break-word","wordBreak":"break-all"}}
